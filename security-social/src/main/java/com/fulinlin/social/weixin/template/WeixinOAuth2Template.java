package com.fulinlin.social.weixin.template;
...
public class WeixinOAuth2Template extends OAuth2Template {
    ...
    /**
     * 这一步是更改原来的oauth2流程获取
     * access_token那一步，因为微信比较特殊
     * 获取access_token的时候 openid也返回了回来
     *
    ...
    private AccessGrant getAccessToken(StringBuilder accessTokenRequestUrl) {
        ...
        try {
            result = JSON.parseObject(response, new TypeReference<Map<String, Object>>() {
            });
        } catch (Exception e) {
            e.printStackTrace();
        }
